...
Before proposing product or UI decisions, read `.cursor/skills/product-designer/context.md` first.
...
- If product direction changes, update `.cursor/skills/product-designer/context.md` before continuing design work.
...
- **Tone-aware**: Match the product voice in `context.md`; avoid robotic, generic, or overly marketing-heavy wording.
